...
class TabBarVC: UITabBar {
    ...
    private func addShape() {
        ...
        shapeLayer.fillColor = CGColor(red: 255, green: 255, blue: 255, alpha: 1)
        shapeLayer.lineWidth = 1.0
        
        shapeLayer.shadowOffset = CGSize(width: 0, height: 0)
        shapeLayer.shadowRadius = 10
        shapeLayer.shadowColor = CGColor(red: 255, green: 255, blue: 255, alpha: 1)
    ...
    override func draw(_ rect: CGRect) {
        self.addShape()
        self.unselectedItemTintColor = UIColor.blue
    ...
    func createPath() -> CGPath {
        ...
        path.move(to: CGPoint(x: 0, y: 0)) //start pos
